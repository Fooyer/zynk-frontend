        ...
        {collapsed ? (
          ...
          <>
            <div className="flex-1 overflow-y-auto py-3 px-2 space-y-5">
              ...
              {/* Início / Eventos / Tickets — space-y-0.5 igual ao padrão usado no
                  rodapé e na lista de Grupos; sem isso herdavam o space-y-5 do
                  container pai (pensado pra separar SEÇÕES, não itens dentro de
                  uma) e ficavam com um espaçamento bem maior que o resto do app. */}
