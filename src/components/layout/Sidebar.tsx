      ...
      <aside className="w-60 bg-surface-800 flex flex-col border-r border-surface-700/50 flex-shrink-0">
        ...
        <div className="px-3 py-2">
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 text-sm text-surface-400 hover:text-surface-100 hover:bg-surface-700 rounded-lg transition-colors-fast"
          >
