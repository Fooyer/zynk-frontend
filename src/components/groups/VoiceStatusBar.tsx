...
/**
 * Barra de call de voz — fixa no canto inferior esquerdo, visível em
 * qualquer tela do app enquanto estou conectado (igual Discord), não só
 * dentro do grupo/canal em questão.
 */
export function VoiceStatusBar({ voice }: Props) {
  ...
  return (
    <>
      <div className="fixed bottom-3 left-[84px] z-30 w-64 bg-surface-800 border border-surface-700 rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[70vh]">
        {/* Header */}
